...
export const init = async (model) => {
    ...
    for (let i = 0; i < songs.length; i++) {
        ...
        try {
            ...
            songScales.push({ x: X_RANGE / (2 * gridCols), y: Y_RANGE / (2 * gridRows) });
    ...
    model.animate(() => {
        ...
        if (state.started && state.activeSongIdx !== null) {
            ...
            for (let i = 0; i < lyricNodes[state.activeSongIdx].length; i++) {
                ...
                let scaleFactor = 1;
                let color = [1, 1, 1];
                const { x: bsx, y: bsy } = songScales[state.activeSongIdx];
                ...
                node
                    ...
                    .scale(bsx * scaleFactor, bsy * scaleFactor, bsx * scaleFactor)
                    .opacity(opacity)
